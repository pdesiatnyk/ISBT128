...
namespace Iccbba.Isbt128
{
    ...
    public static class ReferenceTables
    {
        ...
        public static bool IsDinChecksumFlag(string ff) => int.TryParse(ff, out var value) && value >= 60 && value <= 96;

        /// <summary>Table 4 — Blood Groups [ABO and RhD], including type-of-collection column [RT005] (ST-001 §3.1).</summary>
        private static readonly Dictionary<string, string> BloodGroupGg = new Dictionary<string, string>
        {
        ...
        private static readonly Dictionary<string, string> SpecialMessagesGg = new Dictionary<string, string>
        {
        ...
        {
            Dictionary<string, (string Kell, string C, string CLower, string E, string ELower)> table = new Dictionary<string, (string Kell, string C, string CLower, string E, string ELower)>
            {
        ...
        private static readonly Dictionary<string, string> DimensionSymbols = new Dictionary<string, string>
        {
        ...
        private static readonly Dictionary<string, (string Unit, string Description)> DimensionUnits = new Dictionary<string, (string Unit, string Description)>
        {
        ...
        public static string ApplyDimensionDecimalPoint(string ccccc, string d)
        {
            switch (d)
            {
                case "0": return ccccc;
                case "1": return $"{ccccc.Substring(0, 4)}.{ccccc.Substring(4)}";
                case "2": return $"{ccccc.Substring(0, 3)}.{ccccc.Substring(3)}";
                case "3": return $"{ccccc.Substring(0, 2)}.{ccccc.Substring(2)}";
                case "4": return $"{ccccc.Substring(0, 1)}.{ccccc.Substring(1)}";
                case "5": return $".{ccccc}";
                default: return ccccc;
            }
        }

        /// <summary>Table 22 — RBC Serological Results [RT040] (ST-001 §3.1, Data Structure 030).</summary>
        private static readonly Dictionary<string, string> RbcSerologicalResult = new Dictionary<string, string>
        {
        ...
        private static readonly Dictionary<string, string> NumberOfTestsTable = new Dictionary<string, string>
        {
        ...
        private static readonly Dictionary<string, string> TimeZoneTable = new Dictionary<string, string>
        {
        ...
        private static readonly Dictionary<string, string> TypeOfTimeTable = new Dictionary<string, string>
        {
        ...
        private static readonly Dictionary<string, string> SecCodingSystemTable = new Dictionary<string, string>
        {
        ...
        /// </summary>
        public static readonly Dictionary<string, (string A, string B)> PairedResultLegend = new Dictionary<string, (string A, string B)>
        {
        ...
        private static readonly Dictionary<string, string> RhPhenotypeTable = new Dictionary<string, string>
        {
        ...
        public static readonly string[] Rt009AntigenNames = new[] { "K", "k", "Cw", "Mia", "M", "N", "S", "s", "U", "P1", "Lua", "Kpa", "Lea", "Leb", "Fya", "Fyb" };
